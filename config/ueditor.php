...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/UEuploads/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/UEuploads/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/UEuploads/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/UEuploads/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/UEuploads/video/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'filePathFormat' => '/UEuploads/file/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'imageManagerListPath' => '/UEuploads/image/', /* 指定要列出图片的目录 */
        ...
        'fileManagerListPath' => '/UEuploads/file/', /* 指定要列出文件的目录 */
