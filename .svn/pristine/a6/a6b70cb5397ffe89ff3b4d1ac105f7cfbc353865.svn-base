        ...
        <div class="layui-card">
            <div class="layui-card-body">
                <div style="padding-bottom: 10px;">
                    <button class="layui-btn layuiadmin-btn-list" data-type="add">新增仓库</button>
                </div>
...
<script>
    layui.config({
        ...
        table.on("tool(LAY-app-content-list)", function(t) {
            var e = t.data;
            "del" === t.event ? layer.confirm("确定删除此仓库？", function(e) {
                $.ajax({
                    type : "DELETE",
                    url : "/master/depot/"+t.data.id,
                ...
                type: 2,
                title: "编辑仓库",
                content: '/master/depot/'+e.id+'/edit',
                maxmin: !0,
                area: ['800px', '500px'],
                btn: ["确定", "取消"],
                yes: function(e, i) {
