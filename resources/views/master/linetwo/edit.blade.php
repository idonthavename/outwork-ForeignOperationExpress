...
<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" lay-verType="tips" class="layui-input" autocomplete="on" placeholder="请输入二级线路" value="{{$data['name']}}">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="print_template" lay-verify="required" lay-verType="tips">
                <option value="">请选择</option>
                @foreach($print_template as $key=>$val)
                    <option value="{{$key}}" {{$data['print_template'] == $key ? 'selected' : ''}}>{{$val['name']}}</option>
                @endforeach
            </select>
        </div>
    </div>
